...
const styles = {
  ...
  title: { fontFamily: "'Syne', sans-serif", fontSize: 16, fontWeight: 800, color: '#e8edf5' },
  closeBtn: { background: 'transparent', border: 'none', color: '#3d4f6a', cursor: 'pointer', fontSize: 18, padding: 4 },
  ...
  sublabel: { fontFamily: "'Space Mono', monospace", fontSize: 10, color: '#3d4f6a', marginTop: 2 },
  optional: { color: '#3d4f6a' },
  input: {
  ...
  preview: { fontFamily: "'Space Mono', monospace", fontSize: 11, color: '#3d4f6a' },
  toggleRow: { display: 'flex', alignItems: 'center', justifyContent: 'space-between', cursor: 'pointer' },
  toggle: {
    width: 44, height: 24, background: '#111827',
    border: '1.5px solid #1e2d45', borderRadius: 12,
    position: 'relative', cursor: 'pointer', flexShrink: 0, transition: 'all 0.2s',
  },
  toggleOn: { background: 'rgba(79,158,255,0.15)', borderColor: 'rgba(79,158,255,0.4)' },
  toggleThumb: { position: 'absolute', top: 3, left: 3, width: 16, height: 16, background: '#3d4f6a', borderRadius: '50%', transition: 'all 0.2s' },
  toggleThumbOn: { left: 23, background: '#4f9eff' },
  error: {
    fontFamily: "'Space Mono', monospace", fontSize: 11, color: '#ff4f8b',
    padding: '10px 14px', background: 'rgba(255,79,139,0.08)',
    border: '1px solid rgba(255,79,139,0.2)', borderRadius: 8,
  },
  actions: { display: 'flex', gap: 10, justifyContent: 'flex-end', marginTop: 4 },
  cancelBtn: {
    background: 'transparent', border: '1.5px solid #1e2d45',
    color: '#7a8ba8', padding: '10px 20px',
    fontFamily: "'Space Mono', monospace", fontSize: 11,
    cursor: 'pointer', borderRadius: 10,
  },
  createBtn: {
    background: 'linear-gradient(135deg, #4f9eff, #4fffb0)',
    border: 'none', color: '#070b14', padding: '10px 20px',
