      ...
      <style>{`
        * { box-sizing: border-box; }
        ...
        @media (min-width: 768px) {
          .sidebar-desktop { position: static !important; transform: none !important; height: 100vh !important; }
        }
      `}</style>
    </>
  )
...
const styles = {
  ...
  headerLeft: { display: 'flex', alignItems: 'center', gap: 6, overflow: 'hidden', flex: 1 },
  menuBtn: {
  ...
  empty: {
    ...
    opacity: 0.3, padding: '60px 20px',
  },
  emptyTitle: { fontFamily: "'Syne', sans-serif", fontSize: 24, fontWeight: 800, color: '#f0f0f0', marginBottom: 8 },
